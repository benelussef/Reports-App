   ...
   function data($resultat){
        for($i=0;$i<count($resultat);$i++){
           ...
           <tr>
                                                       ...
                                                       <td>$pp</td>
                                                       <td>$pc</td>
                                                       <td><a href='DetailsM.php?idD=$id' class='btn btn-warning'>Details</a></td>
                                                       <td><a href='suppM.php?idS=$id' class='btn btn-danger'>Supprimer</a></td>
           </tr>";                                      
